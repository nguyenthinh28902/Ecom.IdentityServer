...
namespace Ecom.IdentityServer.Services.Interfaces
{
    public interface IInternalTokenService
    {
        ...
        /// </summary>
        Task<TokenResponseDto?> GetSystemTokenAsync(ServiceAuthOptions cfg);

        /// <summary>
        /// Lấy token có chứa ngữ cảnh người dùng (User Payload).
        /// Dùng để truyền thông tin user hiện tại xuống các service hạ tầng.
        /// </summary>
        Task<TokenResponseDto?> GetUserScopedTokenAsync(SignInResponseDto userContext, ServiceAuthOptions cfg);
